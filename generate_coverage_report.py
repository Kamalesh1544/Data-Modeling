...
def generate_report(xml_file, build_number, previous_build_number, changed_files):
...
if __name__ == "__main__":
    ...
    report = generate_report(xml_file, build_number, previous_build_number, changed_files)
    print(report)
