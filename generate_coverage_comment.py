...
- {data['changed_files']} of {data['changed_files']} (100.0%) changed or added relevant lines in 1 file are covered.
- No unchanged relevant lines lost coverage.
- Overall coverage increased ({data['coverage_increase']}) to {data['coverage_percentage']}

| Totals | |
|:--|:--|
| Coverage | {data['coverage_percentage']} |
| Change from base Build {data['previous_build']} | {data['coverage_increase']} |
